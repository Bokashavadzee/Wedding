    ...
    <form action="" method="post">
         ...
         <div class="flex">
                ...
                <div class="inputBox">
                    ...
                    <input type="number" placeholder="type your number" name="number" required>
                </div>
                ...
                <div class="inputBox">
                    ...
                    <textarea name="address" placeholder="type your address" required cols="30" rows="10"></textarea>
                </div>
                ...
                <div class="inputBox">
                    ...
                    <textarea name="message" placeholder="type your message" required cols="30" rows="10"></textarea>
                </div>
